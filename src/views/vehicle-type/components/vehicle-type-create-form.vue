...
const { createForm, dialogData } = storeToRefs(vehicleTypeStore)
...
const handleConfirm = () => {
  createFormRef.value?.validate(
    assertFormValidate(() =>
      api.vehicleTypeController.save({ body: createForm.value }).then(async (res) => {
  ...
  <div class="create-form">
    <el-form labelWidth="120" class="form" ref="createFormRef" :model="createForm" :rules="rules">
      <el-form-item label="型号" prop="typeName">
        <el-input v-model="createForm.typeName"></el-input>
      </el-form-item>
      <el-form-item label="型号大小" prop="typeSize">
        <el-input v-model="createForm.typeSize"></el-input>
      </el-form-item>
      <el-form-item label="燃油类型" prop="fuelType">
        <el-input v-model="createForm.fuelType"></el-input>
      </el-form-item>
      <el-form-item label="制造厂家" prop="manufacturer">
        <el-input v-model="createForm.manufacturer"></el-input>
      </el-form-item>
      <el-form-item label="正座数量" prop="passengerCapacity">
        <el-input-number v-model="createForm.passengerCapacity"></el-input-number>
      </el-form-item>
      <el-form-item label="副座数量" prop="extraPassengerCapacity">
        <el-input-number v-model="createForm.extraPassengerCapacity"></el-input-number>
      </el-form-item>
      <el-form-item label="行李容量" prop="luggageCapacity">
        <el-input-number v-model="createForm.luggageCapacity"></el-input-number>
      </el-form-item>
    </el-form>
