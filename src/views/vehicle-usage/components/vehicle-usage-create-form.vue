...
const { createForm, dialogData } = storeToRefs(vehicleUsageStore)
...
const handleConfirm = () => {
  createFormRef.value?.validate(
    assertFormValidate(() =>
      api.vehicleUsageController.save({ body: createForm.value }).then(async (res) => {
  ...
  <div class="create-form">
    <el-form labelWidth="120" class="form" ref="createFormRef" :model="createForm" :rules="rules">
      <el-form-item label="停车费用" prop="tripCostParking">
        <el-input-number v-model="createForm.tripCostParking"></el-input-number>
      </el-form-item>
      <el-form-item label="超时费用" prop="tripCostSurpass">
        <el-input-number v-model="createForm.tripCostSurpass"></el-input-number>
      </el-form-item>
      <el-form-item label="用车费用" prop="tripCostFee">
        <el-input-number v-model="createForm.tripCostFee"></el-input-number>
      </el-form-item>
      <el-form-item label="其他费用" prop="tripCostOther">
        <el-input-number v-model="createForm.tripCostOther"></el-input-number>
      </el-form-item>
      <el-form-item label="加油费用" prop="tripCostFuel">
        <el-input-number v-model="createForm.tripCostFuel"></el-input-number>
      </el-form-item>
      <el-form-item label="司机费用" prop="tripCostLabor">
        <el-input-number v-model="createForm.tripCostLabor"></el-input-number>
      </el-form-item>
      <el-form-item label="高速费用" prop="tripCostEtc">
        <el-input-number v-model="createForm.tripCostEtc"></el-input-number>
      </el-form-item>
      <el-form-item label="用车预定时间" prop="tripReservedTime">
        <el-date-picker
          v-model="createForm.tripReservedTime"
          type="datetime"
          placeholder="请选择日期"
